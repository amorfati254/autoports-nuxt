...
<template>
  <footer class="relative overflow-hidden">
    ...
    <div aria-hidden="true" class="flex absolute start-0 -z-[1]">
      <div class="bg-purple-200 opacity-10 blur-3xl w-[1036px] h-[600px] dark:bg-purple-900 dark:opacity-20" />
      <div class="bg-slate-200 opacity-20 blur-3xl w-[577px] h-[300px] transform translate-y-32 dark:bg-slate-800/60" />
    </div>
    <!-- End Gradients -->
      ...
      <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6 mb-10">
        <div class="col-span-full hidden lg:col-span-1 lg:block">
          <a class="flex-none" href="#">
            <svg
              class="w-24 h-auto" width="116" height="32" viewBox="0 0 116 32" fill="none"
          ...
          <div class="mt-3 grid space-y-3 text-sm">
            ...
            <p>
              <a
                ...
                href="#"
              >Careers</a>
              <span class="inline text-violet-600 dark:text-violet-500">— We're hiring</span>
            </p>
            <p>
              <a
                class="inline-flex gap-x-2 text-gray-600 hover:text-gray-800 dark:text-gray-400 dark:hover:text-gray-200 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
        ...
        <div class="sm:flex sm:justify-between sm:items-center">
          <div class="flex items-center gap-x-3">
            ...
            <div class="hs-dropdown relative inline-flex [--placement:top-left]">
              <button
                id="footer-language-dropdown" type="button"
              ...
              >
                <svg
                  id="flag-icon-css-us1" class="size-3 rounded-full" xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 512 512"
                >
                  <g fill-rule="evenodd">
                    <g stroke-width="1pt">
                ...
                English (US)
                <svg
                  class="hs-dropdown-open:rotate-180 flex-shrink-0 size-4 text-gray-600"
              ...
              >
                <a
                  class="flex items-center gap-x-2 py-2 px-3 rounded-lg text-sm text-gray-800 hover:bg-gray-100 focus:ring-2 focus:ring-violet-500 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-300 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                  href="#"
                >
                  <svg
                    id="flag-icon-css-us" class="size-3.5 rounded-full" xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 512 512"
                  >
                    <g fill-rule="evenodd">
                      <g stroke-width="1pt">
                ...
                >
                  <svg
                    id="flag-icon-css-de" class="size-3 rounded-full" xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 512 512"
                  >
                ...
                >
                  <svg
                    id="flag-icon-css-dk" class="size-3 rounded-full" xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 512 512"
                  >
                ...
                >
                  <svg
                    id="flag-icon-css-it" class="size-3 rounded-full" xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 512 512"
                  >
                ...
                >
                  <svg
                    id="flag-icon-css-cn" class="size-3 rounded-full" xmlns="http://www.w3.org/2000/svg"
          ...
          <div class="flex justify-between items-center">
            ...
            <div class="space-x-4">
              <a class="inline-block text-gray-500 hover:text-gray-800 dark:hover:text-gray-200" href="#">
                <svg
                  class="size-4" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                  viewBox="0 0 16 16"
                >
                  <path
